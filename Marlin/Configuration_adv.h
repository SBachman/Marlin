...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  // Add Probe Z Offset calibration to the Z Probe Offsets menu
    ...
    #define PROBE_OFFSET_WIZARD
      ...
      #define PROBE_OFFSET_START -0.76  // Estimated nozzle-to-probe Z offset, plus a little extra
    #endif
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    32  // (mm) Slow length, to allow time to insert material.
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT    940       // (mA) RMS current. 90% of rated
    #define E0_MICROSTEPS  16
